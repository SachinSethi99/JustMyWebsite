...
const Home = () => {
    return (
        <div className="min-h-screen flex flex-col bg-beige text-darkGray font-sans">
            <Head>
            ...
            <header className="fixed top-0 left-0 w-full bg-darkGray shadow-md z-50">
                <nav className="flex justify-center py-4">
                    <ul className="flex space-x-8">
                        ...
                        <li><Link to="contact" smooth={true} duration={500} className="text-white hover:text-teal-400">📞 Contact</Link></li>
                    </ul>
                </nav>
            </header>

            <main className="flex-1 flex flex-col items-center justify-center mt-16 p-8">
                <section className="text-center mb-16 flex flex-col items-center">
                    <div className="relative">
                        <img src="/images/personal.jpg" alt="Sachin Sethi" className="w-40 h-40 rounded-full border-4 border-black object-cover absolute right-0 -mr-20" />
                    </div>
                ...
                <Element name="about" className="mb-16">
                    <h2 className="text-3xl font-bold text-teal-400 mb-4">About Me</h2>
                    <p className="text-lg leading-relaxed">
                        Hi there! 👋 I'm a passionate Software Engineer who loves mixing up .NET, Java, Python, and AWS to cook up amazing user experiences. With a strong skill set in JavaScript, React.js, Node.js, and MySQL, I whip up innovative solutions that ensure top-notch performance and seamless functionality. 💻✨
                ...
                <Element name="education" className="mb-16">
                    ...
                    <div className="education-item mb-8">
                        ...
                        <p className="text-lg text-gray-700 mb-2">September 2019 - July 2022</p>
                ...
                <Element name="skills" className="mb-16">
                    ...
                    <ul className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        <li className="bg-gray-800 p-2 rounded text-center">☕ Java</li>
                        <li className="bg-gray-800 p-2 rounded text-center">🔧 C#/.NET</li>
                        <li className="bg-gray-800 p-2 rounded text-center">🐍 Python</li>
                        <li className="bg-gray-800 p-2 rounded text-center">🌐 JavaScript</li>
                        <li className="bg-gray-800 p-2 rounded text-center">⚛️ React.js</li>
                        <li className="bg-gray-800 p-2 rounded text-center">🟢 Node.js</li>
                        <li className="bg-gray-800 p-2 rounded text-center">☁️ AWS</li>
                        <li className="bg-gray-800 p-2 rounded text-center">🔄 CI/CD</li>
                        <li className="bg-gray-800 p-2 rounded text-center">🔀 Git</li>
                        <li className="bg-gray-800 p-2 rounded text-center">🔗 REST APIs</li>
                        <li className="bg-gray-800 p-2 rounded text-center">🗃️ SQL Server</li>
                        <li className="bg-gray-800 p-2 rounded text-center">🐘 PostgreSQL</li>
                        <li className="bg-gray-800 p-2 rounded text-center">🌐 HTML/CSS</li>
                        <li className="bg-gray-800 p-2 rounded text-center">🧪 Unit Testing</li>
                        <li className="bg-gray-800 p-2 rounded text-center">🧩 Lua</li>
                    </ul>
                </Element>

                <Element name="experience" className="mb-16">
                ...
                <Element name="contact" className="mb-16">
                    <h2 className="text-3xl font-bold text-teal-400 mb-4">Contact</h2>
                    <p className="text-lg leading-relaxed">
                        📧 <strong>Email:</strong> <a href="mailto:sachinsethi2017@gmail.com" className="text-teal-400 hover:underline">sachinsethi2017@gmail.com</a><br />
                        📞 <strong>Phone:</strong> +44 7481080451<br />
                        💼 <strong>LinkedIn:</strong> <a href="https://www.linkedin.com/in/Sachin-Sethi-SS" className="text-teal-400 hover:underline">Sachin-Sethi-SS</a><br />
                        🖥️ <strong>GitHub:</strong> <a href="https://github.com/SachinSethi99" className="text-teal-400 hover:underline">SachinSethi99</a><br />
            ...
            <footer className="bg-darkGray text-center py-4">
                <p className="text-lg mb-2 text-gray-400">&copy; 2024 Sachin Sethi. All rights reserved. 🌟</p>
                <p className="text-lg text-gray-400">Made with 💻, ☕, and a lot of ❤️.</p>
            </footer>
        </div>
    );
};
