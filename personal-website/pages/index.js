...
const Home = () => (
    <div className="min-h-screen flex flex-col font-sans">
        ...
        <main className="flex-1 mt-24">
            ...
            <Element name="about" className="bg-white text-darkGray p-8 pt-20">
            ...
            <Element name="education" className="bg-white text-darkGray p-8 pt-20">
            ...
            <Element name="skills" className="bg-beige text-darkGray p-8 pt-20">
            ...
            <Element name="experience" className="bg-lightGray text-darkGray p-8 pt-20">
            ...
            <Element name="projects" className="bg-white text-darkGray p-8 pt-20">
